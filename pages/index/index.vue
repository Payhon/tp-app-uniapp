...
type ChartDataPoint = number | { value: number; color?: string }
...
interface HistogramData2 {
	label: string[]
	value: SimpleSeries[]
}

interface ArcbarData {
...
const histogramData = ref<HistogramData>({
	...
	series: [
		{
			name: t('pages.charts.volume1'), //数据名称
			data: [
				15,
				{
...
const histogramData2 = ref<HistogramData2>({
...
const histogramData3 = ref<HistogramData>({
	//柱状标准图
	categories: ['2013', '2014', '2015', '2016', '2017', '2018'],
	series: [
		{
			name: t('pages.charts.category1'),
			data: [35, 36, 31, 33, 13, 34]
		},
		{
			name: t('pages.charts.category2'),
...
const arcbarList = ref<ArcbarData[]>([
	//圆环
	{
		series: [
			{
				name: t('pages.charts.accuracy'),
				data: 0.2912
			}
		]
	},
	...
	},
	{
		series: [
			{
				name: t('pages.charts.mistakeRate'),
				data: 0.8232
			}
		]
	}
...
const lineData = ref<LineData>({
	...
	series: [
		{ name: t('pages.charts.volumeA'), data: [0.3511, 0.8233, 0.25, 0.37, 0.4, 0.2] },
		{ name: t('pages.charts.volumeB'), data: [0.7, 0.4, 0.65, 0.1, 0.44, 0.68] },
		{ name: t('pages.charts.volumeC'), data: [0.1, 0.8, 0.95, 0.15, 0.112, 0.132] }
	]
})

const lineData2 = ref<LineData>({
	//数字的图--折线图数据
	categories: ['2012', '2013', '2014', '2015', '2016', '2017'],
	series: [
		{ name: t('pages.charts.volumeA'), data: [35, 8, 25, 37, 4, 20] },
		{ name: t('pages.charts.volumeB'), data: [70, 40, 65, 100, 44, 68] },
		{ name: t('pages.charts.volumeC'), data: [100, 80, 95, 150, 112, 132] }
	]
})
...
const pieData = ref<PieData>({
	...
	series: [
		{
			name: t('pages.charts.class1'),
			data: 50
		},
		{
			name: t('pages.charts.class2'),
			data: 30
		},
		{
			name: t('pages.charts.class3'),
			data: 20
		},
		{
			name: t('pages.charts.class4'),
			data: 18
		},
		{
			name: t('pages.charts.class5'),
			data: 8
		}
	]
})
