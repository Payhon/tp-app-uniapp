...
function calcCrcForFrame(frameWithoutCrcAndTail) {
...
export function splitIntoRegistersBE(dataBytes) {
...
export function registersToBytesBE(registerValues) {
