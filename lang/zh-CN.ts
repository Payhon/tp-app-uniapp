export default {
  ...
  deviceDetail: {
    ...
    params: {
      ...
      factory: {
        ...
        sleep: '一键休眠',
        powerOff: '一键掉电',
        restoreDefaults: '参数恢复默认',
        clearHistory: '历史记录擦除',
        clearCycles: '循环次数擦除',
        clearProtection: '保护状态清除',
      },
      demo: {
        cellOvAlarmV: '过充告警电压',
  ...
  bmsParam: {
    ...
    CELL_OC_ALARM_RELEASE_DELTA_V: '过充告警解除电压差',
    ...
    CHARGE_OC_PROTECT_SMALL_A: '充电过流保护小电流',
    CHARGE_OC_PROTECT_LARGE_A: '充电过流保护大电流',
    ...
    CELL_OVER_TEMP_PROTECT_C: '电芯过温保护温度',
    CELL_OVER_TEMP_RELEASE_C: '电芯过温保护恢复温度',
    CELL_UNDER_TEMP_PROTECT_C: '电芯欠温保护温度',
    CELL_UNDER_TEMP_RELEASE_C: '电芯欠温保护恢复温度',
  },
  components: {
    popup: {
      title: '提示',
